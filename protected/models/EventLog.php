...
/**
 * This is the model class for table "umb_event_log".
 *
 * The followings are the available columns in table 'umb_event_log':
 * @property integer $id
